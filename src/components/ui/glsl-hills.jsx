...
const GLSLHills = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5, className = "" }) => {
  ...
  useEffect(() => {
    ...
    class Plane {
      constructor() {
        ...
        this.uniforms = {
          time: { type: 'f', value: 0 },
          uColor: { type: 'v3', value: isLight ? new THREE.Color('#7C766E') : new THREE.Color(0.6, 0.6, 0.6) },
          uOpacityMult: { type: 'f', value: isLight ? 1.8 : 0.6 },
        };
        ...
        return new THREE.Mesh(
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                float opacity = (96.0 - length(vPosition)) / 256.0 * uOpacityMult;
  ...
  }, [cameraZ, planeSize, speed, resolvedTheme]);
