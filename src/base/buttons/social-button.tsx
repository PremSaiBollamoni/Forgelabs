...
import { AppleLogo, DribbleLogo, FacebookLogo, FigmaLogo, FigmaLogoOutlined, GithubLogo, GoogleLogo, LinkedinLogo, TwitterLogo, WhatsappLogo } from "./social-logos";
...
export const styles = sortCx({
    ...
    colors: {
        ...
        whatsapp: {
            root: "bg-[#25D366] text-white shadow-xs-skeuomorphic ring-1 ring-transparent ring-inset before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0% hover:bg-[#128C7E]",
            icon: "",
        },
    },
});
...
interface CommonProps {
    social: "google" | "facebook" | "apple" | "twitter" | "figma" | "dribble" | "github" | "whatsapp" | "linkedin";
    disabled?: boolean;
        ...
        >
            <Logo
                className={cx(
                    ...
                    theme === "gray"
                        ? colorStyles.icon
                        : theme === "brand" && (social === "facebook" || social === "apple" || social === "twitter" || social === "linkedin")
                          ? "text-white"
